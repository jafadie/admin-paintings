(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminPaintingsComponent = /** @class */ (function () {
                function AdminPaintingsComponent() {
                }
                AdminPaintingsComponent.prototype.ngOnInit = function () {
                    console.log('admin-paintings.component.ts cargado');
                };
                AdminPaintingsComponent.prototype.processSelectedIdSerie = function (idSerie) {
                    this.selectedIdSerie = idSerie;
                };
                AdminPaintingsComponent.prototype.processSelectedPainting = function (painting) {
                    this.selectedPainting = painting;
                };
                return AdminPaintingsComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BioComponent = /** @class */ (function () {
                function BioComponent(_route, _router, _paintingService) {
                    this._route = _route;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactComponent = /** @class */ (function () {
                function ContactComponent(_route, _router, _userService) {
                    this._route = _route;
                    this._router = _router;
                ...
                ContactComponent.prototype.initializeUser = function () {
                    this.user = new _models_user_model__WEBPACK_IMPORTED_MODULE_4__["User"]('', '');
                };
                ContactComponent.prototype.onSubmit = function () {
                    this.createUser();
                };
                ContactComponent.prototype.createUser = function () {
                    var _this = this;
                    this._userService.createUser(this.user).subscribe(function (result) {
                        console.log('User successfully created!');
                        _this.sendMailSubscription();
                ...
                ContactComponent.prototype.sendMailSubscription = function () {
                    var date = new Date();
                    console.log(date);
                    this._userService.sendMailAfterSubscription(this.user, date).subscribe(function (result) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DragDropComponent = /** @class */ (function () {
                ...
                DragDropComponent.prototype.add = function () {
                    this.items.push(this.items.length + 1);
                };
                DragDropComponent.prototype.shuffle = function () {
                    this.items.sort(function () {
                        return .5 - Math.random();
                    });
                };
                DragDropComponent.prototype.drop = function () {
                    if (!this.target)
                        return;
                    console.log('droppp');
                    console.log(this.placeholder);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Notification = /** @class */ (function () {
                function Notification(idNotification, type, scheduled, eventType, title, localization, openingDate, closingDate, image, deliveryDate, mediaType, link, userList) {
                }
                return Notification;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var NotificationSent = /** @class */ (function () {
                function NotificationSent(idNotificationSent, idNotification, type, scheduled, eventType, title, localization, openingDate, closingDate, image, deliveryDate, mediaType, link, userList) {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Painting = /** @class */ (function () {
                function Painting(idPainting, title, year, height, width, technique, image, idSerie, visible, available, order) {
                }
                return Painting;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Serie = /** @class */ (function () {
                function Serie(idSerie, title, visible) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationCreateComponent = /** @class */ (function () {
                function NotificationCreateComponent(_route, _router, _userService, _notificationService, _notificationSentService) {
                    this._route = _route;
                    this._router = _router;
                    this._userService = _userService;
                ...
                NotificationCreateComponent.prototype.ngOnInit = function () {
                    console.log('notification-create.component.ts cargado');
                };
                NotificationCreateComponent.prototype.fillEventTypesNuevaExpo = function () {
                    this.eventTypes = [
                        {
                            idEventType: 0,
                ...
                NotificationCreateComponent.prototype.fillEventTypesArticulosPrensa = function () {
                    this.eventTypes = [
                        {
                            idEventType: 0,
                ...
                NotificationCreateComponent.prototype.fillMediaTypes = function () {
                    this.mediaTypes = [
                        {
                            idMediaType: 0,
                            description: 'Impreso'
                ...
                NotificationCreateComponent.prototype.fileChangeEvent = function (fileInput) {
                    this.filesToUpload = fileInput.target.files;
                };
                NotificationCreateComponent.prototype.cargandoImagen = function (files) {
                    console.log(files);
                    this._notificationService.postFileImagen(files[0]).subscribe(function (response) {
                        console.log(response);
                    }, function (error) {
                        console.log(error);
                    });
                };
                NotificationCreateComponent.prototype.onSubmit = function () {
                    ...
                    var i = 0;
                    for (var _i = 0, _a = this.myUserList; _i < _a.length; _i++) {
                        var myUser = _a[_i];
                        if (myUser[0]) {
                ...
                NotificationCreateComponent.prototype.createAndSendNewNotification = function () {
                    var _this = this;
                    this._notificationService.getSequenceNumber().subscribe(function (result) {
                        _this.notification['idNotification'] = result['seq'];
                        _this.createAndSendNotification();
                    }, function (error) {
                        console.log(error);
                    });
                };
                NotificationCreateComponent.prototype.createAndSendNotification = function () {
                    var _this = this;
                    this._notificationService.createNotification(this.notification).subscribe(function (result) {
                        console.log('Notification successfully created!');
                        //if (!this.notification['scheduled'])
                        //{
                        _this.notificationSent['idNotification'] = _this.notification['idNotification'];
                        _this.notificationSent['type'] = _this.notification['type'];
                        _this.notificationSent['scheduled'] = _this.notification['scheduled'];
                        _this.notificationSent['eventType'] = _this.notification['eventType'];
                        _this.notificationSent['title'] = _this.notification['title'];
                        _this.notificationSent['localization'] = _this.notification['localization'];
                        _this.notificationSent['openingDate'] = _this.notification['openingDate'];
                        _this.notificationSent['closingDate'] = _this.notification['closingDate'];
                        _this.notificationSent['image'] = _this.notification['image'];
                        _this.notificationSent['deliveryDate'] = new Date();
                        _this.notificationSent['mediaType'] = _this.notification['mediaType'];
                        _this.notificationSent['link'] = _this.notification['link'];
                        _this.notificationSent['userList'] = _this.notification['userList'];
                        _this.createNewNotificationSent();
                        //}
                    }, function (error) {
                        console.log(error);
                    });
                };
                NotificationCreateComponent.prototype.createNewNotificationSent = function () {
                    var _this = this;
                    this._notificationSentService.getSequenceNumber().subscribe(function (result) {
                        _this.notificationSent['idNotificationSent'] = result['seq'];
                        _this.createNotificationSent();
                    }, function (error) {
                        console.log(error);
                    });
                };
                NotificationCreateComponent.prototype.createNotificationSent = function () {
                    var _this = this;
                    this._notificationSentService.createNotificationSent(this.notificationSent).subscribe(function (result) {
                        console.log('NotificationSent successfully created!');
                        _this.sendNotification(); //to all users selected
                    }, function (error) {
                        console.log(error);
                    });
                };
                NotificationCreateComponent.prototype.sendNotification = function () {
                    for (var _i = 0, _a = this.myUserList; _i < _a.length; _i++) {
                        var myUser = _a[_i];
                        if (myUser[0] == true) {
                ...
                NotificationCreateComponent.prototype.contactForm = function (user) {
                    this._userService.sendMailNotifyEvents(user, this.notification['deliveryDate']).subscribe(function () {
                        console.log('Mail sent correctly');
                    });
                };
                NotificationCreateComponent.prototype.getUsers = function () {
                    var _this = this;
                    this._userService.getUsers().subscribe(function (result) {
                        ...
                        for (var _i = 0, _a = _this.users; _i < _a.length; _i++) {
                            var user = _a[_i];
                            var myUser = [false, user];
                            _this.myUserList[i] = myUser;
                            i++;
                        }
                    }, function (error) {
                        console.log(error);
                ...
                NotificationCreateComponent.prototype.onChangeNotificationType = function (e) {
                    this.getUsers();
                ...
                NotificationCreateComponent.prototype.onOptionEventSelected = function (eventType) {
                    this.notification['eventType'] = eventType;
                };
                NotificationCreateComponent.prototype.onOptionMediaSelected = function (mediaType) {
                    this.notification['mediaType'] = mediaType;
                };
                NotificationCreateComponent.prototype.checkValueScheduled = function (event) {
                    if (event) {
            ...
            NotificationCreateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationScheduledListComponent = /** @class */ (function () {
                function NotificationScheduledListComponent(_route, _router, _notificationService) {
                    this._route = _route;
                    this._router = _router;
                    this._notificationService = _notificationService;
                    this.notifications = [];
                }
                NotificationScheduledListComponent.prototype.ngOnInit = function () {
                    console.log('notification-scheduled-list.component.ts cargado');
                    this.getScheduledNotifications();
                };
                NotificationScheduledListComponent.prototype.getScheduledNotifications = function () {
                    var _this = this;
                    this._notificationService.getScheduledNotifications().subscribe(function (result) {
                        console.log(result);
                ...
                return NotificationScheduledListComponent;
            }());
            NotificationScheduledListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationSentListComponent = /** @class */ (function () {
                function NotificationSentListComponent(_route, _router, _notificationSentService) {
                    this._route = _route;
                    this._router = _router;
                    this._notificationSentService = _notificationSentService;
                    this.notificationsSent = [];
                }
                NotificationSentListComponent.prototype.ngOnInit = function () {
                    console.log('notification-sent-list.component.ts cargado');
                    this.getSentLastFiveNotifications();
                };
                NotificationSentListComponent.prototype.getSentLastFiveNotifications = function () {
                    var _this = this;
                    this._notificationSentService.getLastSentNotifications().subscribe(function (result) {
                        console.log(result);
                        _this.notificationsSent = result;
                    }, function (error) {
                        console.log(error);
                    });
                };
                return NotificationSentListComponent;
            }());
            NotificationSentListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaintingCreateComponent = /** @class */ (function () {
                function PaintingCreateComponent(_route, _router, _paintingService) {
                    this._route = _route;
                    this._router = _router;
                    this._paintingService = _paintingService;
                ...
                PaintingCreateComponent.prototype.initializePainting = function () {
                    return new _models_painting_model__WEBPACK_IMPORTED_MODULE_4__["Painting"](0, '', 0, 0, 0, '', '', 0, true, true, 0);
                };
                PaintingCreateComponent.prototype.ngOnInit = function () {
                    console.log('painting-create.component.ts cargado');
                    this.painting = this.initializePainting();
                };
                PaintingCreateComponent.prototype.onSubmit = function () {
                    if (this.filesToUpload) {
                        this.cargandoImagen(this.filesToUpload);
                ...
                PaintingCreateComponent.prototype.createNewPaintingWithOrderInSerie = function () {
                    var _this = this;
                    this._paintingService.getOrderPainting(this.idSerie).subscribe(function (result) {
                        console.log('Order calculated from database');
                        if (typeof result !== 'undefined' && result.length > 0) {
                            _this.painting['order'] = result[0]['order'] + 1;
                        }
                        else {
                            _this.painting['order'] = 0;
                        }
                        _this.createNewPainting();
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingCreateComponent.prototype.createNewPainting = function () {
                    var _this = this;
                    this._paintingService.getSequenceNumber().subscribe(function (result) {
                        _this.painting['idPainting'] = result['seq'];
                        _this.painting['idSerie'] = _this.idSerie;
                        if (!_this.painting['available'])
                            _this.painting['available'] = false;
                ...
                PaintingCreateComponent.prototype.createPainting = function () {
                    var _this = this;
                    this._paintingService.createPainting(this.painting).subscribe(function (result) {
                        console.log('Painting successfully created!');
                        _this.onSelectIdSerie(_this.painting['idSerie']);
                        _this.onSelectPainting(_this.painting);
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingCreateComponent.prototype.updatePainting = function () {
                    var _this = this;
                    this._paintingService.updatePainting(this.painting['idPainting'], this.painting).subscribe(function (result) {
                ...
                PaintingCreateComponent.prototype.fileChangeEvent = function (fileInput) {
                    this.filesToUpload = fileInput.target.files;
                };
                PaintingCreateComponent.prototype.cargandoImagen = function (files) {
                    console.log(files);
                    this._paintingService.postFileImagen(files[0]).subscribe(function (response) {
                        console.log(response);
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingCreateComponent.prototype.ngOnChanges = function (changes) {
                    this.is_edit = false;
                    this.nameButton = 'Create painting';
                ...
                PaintingCreateComponent.prototype.onSelectIdSerie = function (idSerie) {
                    this.selectIdSerie.emit(idSerie);
                };
                PaintingCreateComponent.prototype.onSelectPainting = function (painting) {
                    this.painting = this.initializePainting(); //vacio el formulario
                    this.selectPainting.emit(this.valorReseteoPainting);
                };
                return PaintingCreateComponent;
            }());
            PaintingCreateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _services_painting_service__WEBPACK_IMPORTED_MODULE_3__["PaintingService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_painting_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/painting.service */ "./src/app/services/painting.service.ts");
            /* harmony import */ var _models_painting_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/painting.model */ "./src/app/models/painting.model.ts");
            var PaintingEditComponent = /** @class */ (function () {
                ...
                function PaintingEditComponent(_route, _router, _paintingService) {
                    this._route = _route;
                    this._router = _router;
                    this._paintingService = _paintingService;
                    this.painting = this.initializePainting();
                ...
                PaintingEditComponent.prototype.initializePainting = function () {
                    return new _models_painting_model__WEBPACK_IMPORTED_MODULE_4__["Painting"](0, '', 0, 0, 0, '', '', 0, true, true, 0);
                };
                PaintingEditComponent.prototype.ngOnInit = function () {
                    console.log('painting-edit.component.ts cargado');
                    //this.getPainting();
                };
                PaintingEditComponent.prototype.getPainting = function () {
                    var _this = this;
                    this._route.params.forEach(function (params) {
                        var id = params['id'];
                        console.log('mi id');
                        console.log(id);
                        _this._paintingService.getPainting(id).subscribe(function (result) {
                            _this.painting = result[0];
                        }, function (error) {
                            console.log(error);
                        });
                    });
                };
                PaintingEditComponent.prototype.onSubmit = function () {
                    this.updatePainting();
                };
                PaintingEditComponent.prototype.updatePainting = function () {
                ...
                return PaintingEditComponent;
            }());
            PaintingEditComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _services_painting_service__WEBPACK_IMPORTED_MODULE_3__["PaintingService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaintingListComponent = /** @class */ (function () {
                function PaintingListComponent(_route, _router, _paintingService) {
                    var _this = this;
                    this._route = _route;
                    this._router = _router;
                    this._paintingService = _paintingService;
                ...
                PaintingListComponent.prototype.ngOnInit = function () {
                    console.log('painting-list.component.ts cargado');
                    this.isVisible = false;
                    this.getPaintingsByIdSerie(-1);
                };
                PaintingListComponent.prototype.getPaintings = function () {
                    var _this = this;
                    this._paintingService.getPaintings().subscribe(function (result) {
                        console.log(result);
                        _this.paintings = result;
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingListComponent.prototype.getPaintingsByIdSerie = function (idSerie) {
                    var _this = this;
                    if (idSerie != -1) {
                        jQuery("#myPaintings").css('display', 'inline');
                        this.isVisible = true;
                    }
                    this._paintingService.getPaintingsByIdSerie(idSerie).subscribe(function (result) {
                        console.log(result);
                        _this.paintings = result;
                    }, function (error) {
                        console.log(error);
                ...
                PaintingListComponent.prototype.onDeletePainting = function (id) {
                    var _this = this;
                    this._paintingService.deletePainting(id).subscribe(function (result) {
                        console.log(result);
                        //TODO preguntar con jQuery si estas seguro que quieres eliminar
                        _this.getPaintingsByIdSerie(_this.idSerie);
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingListComponent.prototype.ngOnChanges = function (changes) {
                ...
                PaintingListComponent.prototype.onSelectPainting = function (painting) {
                    jQuery("#myPaintings").css('display', 'none');
                    this.isVisible = false;
                    this.selectPainting.emit(painting);
                };
                PaintingListComponent.prototype.ngAfterViewInit = function () {
                    if (this.placeholder) {
                        var phElement = this.placeholder.element.nativeElement;
                        phElement.style.display = 'none';
                        phElement.parentNode.removeChild(phElement);
                ...
                PaintingListComponent.prototype.drop = function () {
                    if (!this.target)
                        return;
                    var phElement = this.placeholder.element.nativeElement;
                    var parent = phElement.parentNode;
                ...
                PaintingListComponent.prototype.updateOrderPainting = function (idPainting, painting) {
                    this._paintingService.updateOrderPainting(idPainting, painting).subscribe(function (result) {
                        console.log('Order updated successfully');
                    }, function (error) {
                        console.log(error);
                    });
                };
                PaintingListComponent.prototype.setPaintingClasses = function (painting) {
                    var classes = {
                        my_box: true,
                ...
                return PaintingListComponent;
            }());
            PaintingListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _services_painting_service__WEBPACK_IMPORTED_MODULE_3__["PaintingService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PortfolioComponent = /** @class */ (function () {
                function PortfolioComponent(_route, _router, _paintingService, _serieService) {
                    this._route = _route;
                    this._router = _router;
                    this._paintingService = _paintingService;
                ...
                PortfolioComponent.prototype.loadScript = function (url) {
                    var body = document.body;
                    var script = document.createElement('script');
                    script.innerHTML = '';
                    script.src = url;
                ...
                PortfolioComponent.prototype.ngOnInit = function () {
                    ...
                    this._route.params.subscribe(function (params) {
                        var id = params['id'];
                        _this.getPaintingsByIdSerie(id);
                        _this.getSerieById(id);
                    });
                };
                PortfolioComponent.prototype.loadLibraries = function () {
                ...
                PortfolioComponent.prototype.getPaintings = function () {
                    var _this = this;
                    this._paintingService.getPaintings().subscribe(function (result) {
                        console.log(result);
                        _this.paintings = result;
                ...
                PortfolioComponent.prototype.getPaintingsByIdSerie = function (idSerie) {
                    var _this = this;
                    this._paintingService.getPaintingsByIdSerie(idSerie).subscribe(function (result) {
                        console.log(result);
                        _this.paintings = result;
                ...
                PortfolioComponent.prototype.getSerieById = function (idSerie) {
                    var _this = this;
                    this._serieService.getSerie(idSerie).subscribe(function (result) {
                        console.log(result);
                        _this.serie = result[0];
                    }, function (error) {
                        console.log(error);
                    });
                };
                PortfolioComponent.prototype.onClickImage = function () {
                    this.loadLibraries();
                ...
                PortfolioComponent.prototype.onDeletePainting = function (id) {
                    var _this = this;
                    this._paintingService.deletePainting(id).subscribe(function (result) {
                        console.log(result);
                        _this.getPaintings();
                ...
                PortfolioComponent.prototype.setPaintingClasses = function (painting) {
                    var classes = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SerieCreateComponent = /** @class */ (function () {
                function SerieCreateComponent(_route, _router, _serieService) {
                    this._route = _route;
                    this._router = _router;
                    this._serieService = _serieService;
                    this.selectIdSerie = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                ...
                SerieCreateComponent.prototype.ngOnInit = function () {
                    console.log('serie-create.component.ts cargado');
                };
                SerieCreateComponent.prototype.initializeSerie = function () {
                    this.serie = new _models_serie_model__WEBPACK_IMPORTED_MODULE_4__["Serie"](0, '', true);
                };
                SerieCreateComponent.prototype.onSubmit = function () {
                    this.createNewSerie();
                    console.log('New serie saved');
                };
                SerieCreateComponent.prototype.createNewSerie = function () {
                    var _this = this;
                    this._serieService.getSequenceNumber().subscribe(function (result) {
                        _this.serie['idSerie'] = result['seq'];
                        _this.createSerie();
                    }, function (error) {
                        console.log(error);
                    });
                };
                SerieCreateComponent.prototype.createSerie = function () {
                    var _this = this;
                    this._serieService.createSerie(this.serie).subscribe(function (result) {
                        console.log('Serie successfully created!');
                        _this.initializeSerie();
                        _this.selectIdSerie.emit(result['idSerie']);
                    }, function (error) {
                        console.log(error);
                    });
                };
                return SerieCreateComponent;
            }());
            SerieCreateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SerieListComponent = /** @class */ (function () {
                function SerieListComponent(_route, _router, _serieService) {
                    this._route = _route;
                    this._router = _router;
                    this._serieService = _serieService;
                    this.series = [];
                ...
                SerieListComponent.prototype.ngOnInit = function () {
                    console.log('serie-list.component.ts cargado');
                    this.getSeries();
                };
                SerieListComponent.prototype.getSeries = function () {
                    var _this = this;
                    this._serieService.getSeries().subscribe(function (result) {
                        console.log(result);
                        _this.series = result;
                    }, function (error) {
                        console.log(error);
                ...
                SerieListComponent.prototype.onSelectIdSerie = function (idSerie) {
                    this.selectIdSerie.emit(idSerie);
                };
                SerieListComponent.prototype.onDeleteSerie = function (idSerie) {
                    var _this = this;
                    this._serieService.deleteSerie(idSerie).subscribe(function (result) {
                        console.log(result);
                        //TODO preguntar con jQuery si estas seguro que quieres eliminar
                        _this.getSeries();
                    }, function (error) {
                ...
                SerieListComponent.prototype.ngOnChanges = function (changes) {
                    //si se ha seleccionado una serie diferente
                    if (changes['idSerie'] && changes['idSerie'].previousValue != changes['idSerie'].currentValue) {
                        this.getSeries();
                    }
            ...
            SerieListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _services_serie_service__WEBPACK_IMPORTED_MODULE_3__["SerieService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationService = /** @class */ (function () {
                ...
                NotificationService.prototype.getScheduledNotifications = function () {
                    return this.http.get(this.baseUri + "/scheduled");
                };
                // Get notifications of a type
                NotificationService.prototype.getNotificationsByType = function (type) {
                    var url = this.baseUri + "/readNotification/" + type;
                ...
                NotificationService.prototype.getSequenceNumber = function () {
                    var url = this.baseUri + "/sequenceNotifications";
                    return this.http.get(url);
                };
                // Update notification
                ...
                NotificationService.prototype.postFileImagen = function (imagenParaSubir) {
                    var url = this.baseUri + "/uploadFile";
                    var formData = new FormData();
                    formData.append('image', imagenParaSubir, imagenParaSubir.name);
                    return this.http.post(url, formData);
                };
                // Error handling 
                NotificationService.prototype.errorMgmt = function (error) {
                    var errorMessage = '';
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var NotificationSentService = /** @class */ (function () {
                function NotificationSentService(http) {
                    this.http = http;
                    this.baseUri = 'http://localhost:4000/api/notificationSent';
                    this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().set('Content-Type', 'application/json');
                }
                // Create notificationSent
                NotificationSentService.prototype.createNotificationSent = function (data) {
                    var url = this.baseUri + "/create";
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // Get all notificationsSent
                NotificationSentService.prototype.getNotificationsSent = function () {
                    return this.http.get("" + this.baseUri);
                };
                // Get last notificationsSent
                NotificationSentService.prototype.getLastSentNotifications = function () {
                    var url = this.baseUri + "/readLastNotificationSent";
                    return this.http.get(url);
                };
                // Get notificationSent
                NotificationSentService.prototype.getNotificationSent = function (id) {
                    var url = this.baseUri + "/read/" + id;
                    return this.http.get(url, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
                        return res || {};
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                NotificationSentService.prototype.getSequenceNumber = function () {
                    var url = this.baseUri + "/sequenceNotificationsSent";
                    return this.http.get(url);
                };
                NotificationSentService.prototype.postFileImagen = function (imagenParaSubir) {
                    var url = this.baseUri + "/uploadFile";
                    var formData = new FormData();
                    formData.append('image', imagenParaSubir, imagenParaSubir.name);
                    return this.http.post(url, formData);
                ...
                // Error handling 
                NotificationSentService.prototype.errorMgmt = function (error) {
                    var errorMessage = '';
                    if (error.error instanceof ErrorEvent) {
                        // Get client-side error
                        errorMessage = error.error.message;
            ...
            NotificationSentService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var PaintingService = /** @class */ (function () {
                ...
                // Create painting
                PaintingService.prototype.createPainting = function (data) {
                    var url = this.baseUri + "/create";
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // Get all paintings
                PaintingService.prototype.getPaintings = function () {
                    return this.http.get("" + this.baseUri);
                };
                // Get paintings of a serie
                PaintingService.prototype.getPaintingsByIdSerie = function (idSerie) {
                    var url = this.baseUri + "/readSerie/" + idSerie;
                    return this.http.get(url);
                };
                // Get painting
                ...
                PaintingService.prototype.getOrderPainting = function (idSerie) {
                    var url = this.baseUri + "/readOrder/" + idSerie;
                    return this.http.get(url);
                };
                // Update order of a painting
                PaintingService.prototype.updateOrderPainting = function (id, data) {
                    var url = this.baseUri + "/updateOrder/" + id;
                    return this.http.put(url, data, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                PaintingService.prototype.getSequenceNumber = function () {
                    var url = this.baseUri + "/sequencePaintings";
                    return this.http.get(url);
                };
                // Update painting
                PaintingService.prototype.updatePainting = function (id, data) {
                    var url = this.baseUri + "/update/" + id;
                    return this.http.put(url, data, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // Delete painting
                PaintingService.prototype.deletePainting = function (id) {
                    var url = this.baseUri + "/delete/" + id;
                    return this.http.delete(url, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                PaintingService.prototype.postFileImagen = function (imagenParaSubir) {
                    var url = this.baseUri + "/uploadFile";
                    var formData = new FormData();
                    formData.append('image', imagenParaSubir, imagenParaSubir.name);
                    return this.http.post(url, formData);
                ...
                // Error handling 
                PaintingService.prototype.errorMgmt = function (error) {
                    var errorMessage = '';
                    if (error.error instanceof ErrorEvent) {
                        // Get client-side error
                        errorMessage = error.error.message;
            ...
            PaintingService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SerieService = /** @class */ (function () {
                ...
                // Create serie
                SerieService.prototype.createSerie = function (data) {
                    var url = this.baseUri + "/create";
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                ...
                SerieService.prototype.getSequenceNumber = function () {
                    var url = this.baseUri + "/sequenceSeries";
                    return this.http.get(url);
                };
                // Update serie
                SerieService.prototype.updateSerie = function (id, data) {
                    var url = this.baseUri + "/update/" + id;
                    return this.http.put(url, data, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // Delete serie
                ...
                // Error handling 
                SerieService.prototype.errorMgmt = function (error) {
                    var errorMessage = '';
                    if (error.error instanceof ErrorEvent) {
                        // Get client-side error
                        errorMessage = error.error.message;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.sendMailAfterSubscription = function (data, date) {
                    var url = this.baseUri + "/sendMailAfterSubscription/" + date;
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // 2: Send mail after communication
                UserService.prototype.sendMailAfterCommunication = function (data, date) {
                    var url = this.baseUri + "/sendMailAfterCommunication/" + date;
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // 3: Send mail notify changes
                UserService.prototype.sendMailNotifyChanges = function (data, date) {
                    var url = this.baseUri + "/sendMailNotifyChanges/" + date;
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // 4: Send mail notify events
                UserService.prototype.sendMailNotifyEvents = function (data, date) {
                    var url = this.baseUri + "/sendMailNotifyEvents/" + date;
                    return this.http.post(url, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorMgmt));
                };
                // Error handling 
                UserService.prototype.errorMgmt = function (error) {
                    var errorMessage = '';
                    if (error.error instanceof ErrorEvent) {
                        // Get client-side error
                        errorMessage = error.error.message;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(_route, _router, _serieService) {
                    this._route = _route;
                    this._router = _router;
                    this._serieService = _serieService;
                    this.series = [];
                ...
                HeaderComponent.prototype.getSeries = function () {
                    var _this = this;
                    this._serieService.getSeries().subscribe(function (result) {
                        console.log(result);
                        _this.series = result;
                ...
                HeaderComponent.prototype.highlightMenuNav = function () {
                    (function ($) {
                        $(document).ready(function () {
                ...
                HeaderComponent.prototype.unhighlightMenuNav = function () {
                    (function ($) {
                        $(document).ready(function () {
                ...
                HeaderComponent.prototype.initialMenuNav = function () {
                    (function ($) {
                        $(document).ready(function () {
                            $('#navbarDropdown1').removeClass('active');
                        });
